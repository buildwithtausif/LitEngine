import { list_users, find_user_by_email, find_user_by_id, create_user, edit_user, del_user_by_id, } from "../models/users.model.js";
    ...
    try {
        ...
        if (!newName && !newEmail) {
            return res
                .status(400)
                .json({
                error: "No new data provided. Please provide a name or email to update.",
            });
        }
        ...
        if (newEmail) {
            ...
            if (!validEmail.test(newEmail)) {
                return res
                    .status(400)
                    .json({
                    error: "Bad Request: Invalid or missing parameters. Please check your input and try again.",
                });
            }
    ...
    try {
        ...
        if (deleted_user) {
            ...
            return res
                .status(404)
                .json({
                error: "Not Found: The requested resource doesn’t exist or has been removed.",
            });
        }
    }
    catch (err) {
...
//# sourceMappingURL=users.ctrl.js.map